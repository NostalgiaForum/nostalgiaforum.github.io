...
switch ($params[0]) {
	...
	$mines[$params[1]] = array($this->pos1[$issuer->username][0],$this->pos2[$issuer->username][0],$this->pos1[$issuer->username][1],$this->pos2[$issuer->username][1],$this->pos1[$issuer->username][2],$this->pos2[$issuer->username][2],"null",$issuer->level->getName());
...
if (array_key_exists($name, $mines)) {
	...
	if ($issuer instanceof Player) {
		$issuer->sendChat("[MineReset] " . $name . " has been reset");	
				...
				console("[MineReset] " . $name . " has been reset");
			}
